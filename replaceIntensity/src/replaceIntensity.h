#ifndef _replaceIntensity_H_
#define _replaceIntensity_H_
...
class ReplaceIntensity : public itk::Object
{
...
public:
    ...
    itkTypeMacro(ReplaceIntensity, Object);
