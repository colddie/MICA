...
void print_usage()
{
    /* print usage */
    printf (
                "Usage: subStack [options] inputfile outputprefix\n"
                "Options:\n"
                "-slice         Set the desired slice number, format 'start end'\n"
                "-input         Name of the Inputfile\n"
                "-output        Name of the Outputprefix\n"
                "[-keep]          Keep the origin"
                );
}
...
int main(int argc, char** argv)
{
    ...
    itk::SubStack::Pointer filter = itk::SubStack::New();
