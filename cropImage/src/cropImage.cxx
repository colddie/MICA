...
void print_usage()
{
    /* print usage */
    printf (
                "Usage: cropImage [options] inputfile outputprefix\n"
                "Options:\n"
                "-region        Set the desired region coordinates, format 'xlow xhigh ylow yhigh zlow zhigh'\n"
                "-input         Name of the Inputfile\n"
                "-output        Name of the Outputprefix\n"
                "[-keep]        Keep the origin (default close)\n"
                );
}
