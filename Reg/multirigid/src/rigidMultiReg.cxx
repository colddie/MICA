...
namespace itk{
 ...
 void RigidMultiReg::Initialize(Global &var)
 {
...
/* Run the filter */
void RigidMultiReg::Update(Global &var, std::vector<Parameters> &par)
{
...
void RigidMultiReg::Write(Global &var)
{
...
//void RigidMultiReg::InitializeTransform(const unsigned int &level)
//{
...
///* Set Transform */
//void RigidMultiReg::SetTransform()
//{
...
void RigidMultiReg::BuildTransform() const
{

    typedef Versor3DTransformType *TransformPointer;
    ...
    typedef CenteredTransformInitializer
            <Versor3DTransformType, TImage, TImage> TransformInitializerType;
...
void RigidMultiReg::GoToNextResolution() const
{
