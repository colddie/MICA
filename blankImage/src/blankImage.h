#ifndef _blankImage_H_
#define _blankImage_H_
...
class BlankImage : public itk::Object
{
...
public:
    ...
    std::vector<double>        m_imageorigin;

    /* Standard calss typedefs */
    typedef BlankImage Self;
    ...
    itkTypeMacro(BlankImage, Object);
